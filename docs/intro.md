...
```{admonition} What you will find here
This resource contains:

- an introduction to programming as a scientific tool;
- a practical guide to using Python and Jupyter notebooks in Visual Studio Code;
- fundamental Python programming: variables, lists, conditionals, loops, functions, and data collections;
- interactive exercises and quizzes;
- scientific Python libraries and molecular visualisation;
- reading, cleaning, and visualising experimental data;
